...
//Product List ->Campaign List associated with Channel Id
- (MZCampaignResponse *)getCampaignsWithChannelID:(NSString *)pchannelId Offset:(NSInteger )poffset Latitude:(double)platitute Longitude:(double)plongitude;
